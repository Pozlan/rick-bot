...
FOOTBALL_API_KEY  = os.environ.get("FOOTBALL_API_KEY", "")  # football-data.org — get free key at football-data.org/client/register
...
POSTED_FACTS_FILE = os.path.join(DATA_DIR, "posted_facts.json")
MAX_STORED_FACTS  = 60   # ~2 months at one/day — long enough to avoid repeats, short enough to keep the prompt small
